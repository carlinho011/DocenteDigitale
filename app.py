...
# ==========================================================
# INTERFACCIA PRINCIPALE E NAVIGAZIONE SIDEBAR UNIFICATA
# ==========================================================
...
# ==========================================================
# SEZIONE 1: GENERATORE DI VERIFICHE DI CLASSE
# ==========================================================
if modalita == "🚀 Genera Nuova Verifica":
    ...
    if "testo_verifica" in st.session_state:
        ...
        i_html = f"<table class='tabella-intestazione'><tr><td style='width:60%;font-weight:bold;'>Istituto Superiore</td><td style='width:40%;text-align:right;font-weight:bold;'>Data: ____/____/________</td></tr><tr><td>Alunno/a: _________________________________</td><td style='text-align:right;'>Classe: ________ Sez. ____</td></tr><tr><td style='padding-top:10px;font-size:16px;font-weight:bold;'>Verifica scritta ({diff.capitalize()})</td><td style='padding-top:10px;text-align:right;font-size:16px;font-weight:bold;'>Oggetto: {argomento.capitalize()}</td></tr></table>"
        st.markdown(f"<div id='blocco-foglio-word-target' class='foglio-word'>{i_html}{c_html}</div>", unsafe_allow_html=True)

# ==========================================================
# SEZIONE 2: SCANSIONA E CORREGGI (CON BOX VALUTAZIONE E PDF)
# ==========================================================
    ...
    with col_cr:
        griglia = st.text_area("🔑 Criteri o soluzioni di riferimento:", value=st.session_state.get("testo_verifica", ""), height=260)
